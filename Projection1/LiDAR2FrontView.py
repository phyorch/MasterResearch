...
points_path = "/home/phyorch/MasterResearch/Data/2011_09_26/data/2011_09_26_drive_0048_sync/velodyne_points/data/0000000001.bin"
lidar = np.fromfile(points_path, dtype=np.float32).reshape(-1, 4)

lidar_to_2d_front_view(lidar, v_res=VRES, h_res=HRES, v_fov=VFOV, val="depth",
                       saveto="/home/phyorch/MasterResearch/lidar_depth.png", y_fudge=Y_FUDGE)
