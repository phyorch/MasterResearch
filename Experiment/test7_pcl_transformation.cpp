...
//            9.998621e-01, 7.523790e-03, 1.480755e-02);
//    lid_to_cam_translation = (cv::Mat_<float>(3,1) << -4.069766e-03, -7.631618e-02, -2.717806e-01);
    lid_to_cam_rotation = (cv::Mat_<float>(3,3) << 0.90561604, -0.41074625, -0.10557966,
    -0.037680048, 0.17003788, -0.98471689,
    0.42242128, 0.89575368, 0.1385121);
    lid_to_cam_translation = (cv::Mat_<float>(3,1) << 1.976317, 0.44595647, 0.91545135);
    cv::Mat cam0_to_cam2_rotation, cam0_to_cam2_translation;
